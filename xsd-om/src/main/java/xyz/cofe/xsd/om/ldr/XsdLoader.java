...
public class XsdLoader {
    ...
    private final Function<URI, Result<XsdDoc,String>> partialLoader;
    private final BiConsumer<URI, Consumer<Result<XsdDoc,String>>> asyncPartialLoader = null;
    private final BiFunction<URI, URI, URI> resolveBaseTarget;

    public XsdLoader(Function<URI, Result<XsdDoc,String>> partialLoader, BiFunction<URI, URI, URI> resolveBaseTarget) {
    ...
    public Result<XsdDoc,String> load(URI uri) {
    ...
    private void load(URI uri, Consumer<Result<XsdDoc,String>> resultConsumer) {
        if (uri == null) throw new IllegalArgumentException("uri==null");
