...
public final class XsdSchema implements Xsd, IDAttribute {
    ...
    public List<String> getNestedErrors() {
        ...
        getImports().forEach(imp -> {
            imp.getXsdDocs().values().forEach(ld -> {
                ld.doc().getError().ifPresent(lst::add);
    ...
    public Result<Namespace, String> findNamespaceByPrefix( String prefix ){
        ...
        var nsPrefix = Result.from(
            getNsPrefixes().filter( pref -> prefix.equalsIgnoreCase(pref.getPrefix()) ).head(),
            ()->"namespace prefix not found "+prefix );
        return nsPrefix.fmap( pref -> getNamespaces().find(pref.getNamespace()));
    }
    //endregion
    ...
    public Result<Namespace,String> getSelfNamespace(){
        ...
        return Result
            .from( getTargetNamespace(), ()->"attribute targetNamespace not found")
            .map( ns -> new Namespace(ns, ImList.of(this)) );
    }

    private ImList<NsPrefix> nsPrefixes;
    public ImList<NsPrefix> getNsPrefixes(){
        if( nsPrefixes!=null )return nsPrefixes;
        nsPrefixes = elem().getAttributes().fmap(NsPrefix::parseList);
        return nsPrefixes;
    }
    ...
    public ImList<XsdAnnotation> getAnnotations(){
        ...
        annotations = xmlDoc.getDocumentElement().getChildren().fmap(n -> XsdAnnotation.parseList(n,this));
        return annotations;
    }
    ...
    public ImList<XsdElement> getElements(){
        ...
        elements = xmlDoc.getDocumentElement().getChildren().fmap(n -> XsdElement.parseList(n,this));
        return elements;
    }
    ...
    public ImList<XsdAttribute> getAttributes(){
        ...
        attributes = xmlDoc.getDocumentElement().getChildren().fmap(n -> XsdAttribute.parseList(n,this));
        return attributes;
    }
    ...
    public ImList<XsdSimpleType> getSimpleTypes(){
        ...
        simpleTypes = xmlDoc.getDocumentElement().getChildren().fmap(n -> XsdSimpleType.parseList(n,this));
        return simpleTypes;
    }
    ...
    public ImList<XsdComplexType> getComplexTypes(){
        ...
        complexTypes = xmlDoc.getDocumentElement().getChildren().fmap(n -> XsdComplexType.parseList(n,this));
        return complexTypes;
    }
    ...
    public ImList<XsdGroup> getGroups(){
        ...
        groups = xmlDoc.getDocumentElement().getChildren().fmap(n -> XsdGroup.parseList(n,this));
        return groups;
    }
    ...
    public ImList<XsdAttributeGroup> getAttributeGroups(){
        ...
        attributeGroups = xmlDoc.getDocumentElement().getChildren().fmap(n -> XsdAttributeGroup.parseList(n,this));
    ...
    public ImList<XsdNotation> getNotations(){
        ...
        notations = xmlDoc.getDocumentElement().getChildren().fmap(n -> XsdNotation.parseList(n,this));
        return notations;
    }
    ...
    public ImList<XsdRedefine> getRedefines(){
        ...
        redefines = xmlDoc.getDocumentElement().getChildren().fmap(n -> XsdRedefine.parseList(n,this));
        return redefines;
    }
}
